...
steps, epsilon, n_samples, n_samples_per_param = 1, np.array([10000000000]), 5000, 1
...
np.savetxt('sabc_calibration_combined_30_initial.dat',([alpha_post_sample, cr_post_sample, ce_post_sample, mu_g_post_sample, gamma_post_sample]))
