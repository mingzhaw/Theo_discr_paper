...
import numpy as np
import time
from mhr_model import mhr_model_combined_1
import logging
...
modelout = mhr_model_combined_1([datsize, alpha, cr, ce, mu_g, gamma], name = 'modelout')
...
journal_sabc.save('sabc_journal_combined_1.jrnl')
...
np.savetxt('results/sabc_calibration_combined_1.dat',([alpha_post_sample, cr_post_sample, ce_post_sample, mu_g_post_sample, gamma_post_sample]))
